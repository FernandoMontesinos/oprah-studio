    ...
    switch (tipo) {
        ...
        case 'presentacion':
            ...
            <section class="bg-natural">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <div class="col-12">
                        <a class="text-uppercase contact-button d-flex justify-content-center align-items-center border-bottom-0" href="#">¡contactanos!</a>
                    </div>
                    </div>
                </div>
                </div>
        ...
        case 'listo':
            ...
            <section id="listo" class="bg-grey">
                ...
                <a class="btn-trabajemos contacto d-flex justify-content-center align-items-center text-decoration-none text-uppercase" href="#">
                ¡CONTACTANOS!
                </a>
            </section>
            `;
